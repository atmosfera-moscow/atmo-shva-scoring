...
import { ConfigProvider, AdaptivityProvider, AppRoot, Appearance } from '@vkontakte/vkui'
import { useAppearance, useAdaptivity, useInsets } from '@vkontakte/vk-bridge-react'
import { App } from './App'
