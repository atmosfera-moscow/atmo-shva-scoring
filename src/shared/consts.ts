...
export const REACT_APP_VK_ATMOMY_GROUP_ID = process.env.REACT_APP_VK_ATMOMY_GROUP_ID
export const REACT_APP_VK_SHVA_GROUP_ID = process.env.REACT_APP_VK_SHVA_GROUP_ID
export const REACT_APP_VK_SHVA_ONLINE_GROUP_ID = process.env.REACT_APP_VK_SHVA_ONLINE_GROUP_ID
